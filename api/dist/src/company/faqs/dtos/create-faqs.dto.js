...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Answer cannot be empty' }),
    __metadata("design:type", String)
], CreateFaqDto.prototype, "answer", void 0);
__decorate([
    (0, class_validator_1.IsEnum)(client_1.FaqCategory, { message: 'Must be a valid FAQ category' }),
...
//# sourceMappingURL=create-faqs.dto.js.map