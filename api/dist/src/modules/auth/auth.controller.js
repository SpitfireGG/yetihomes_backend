...
let AuthController = class AuthController {
    ...
    async changePassword(adminId, body) {
        await this.authService.changePassword(adminId, body.current_password, body.new_password);
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.NO_CONTENT),
    __param(0, (0, admin_decorator_1.CurrentAdmin)('id')),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)('me'),
    __param(0, (0, admin_decorator_1.CurrentAdmin)()),
    __metadata("design:type", Function),
