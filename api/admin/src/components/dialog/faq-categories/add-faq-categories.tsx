...
import { TripHighlightsFormData } from "@/@types/trips";
            ...
            <form>
                ...
                <DialogContent className="sm:max-w-[525px]">
                    ...
                    <div className="grid gap-4 space-y-4">
                        ...
                        />
                        {/* <TextAreaInput label="description" name="description" value={formData[0].translations[0].description}
                            onChange={(e) => onChangeHandle(e, 0, 0)} /> */}

                        <div className='space-y-3'>
                            <Label>Language</Label>
                            <Select value={formData.translations[0].language_id} onValueChange={(value) => onSelectChange(value, 0, "language_id")} required>
