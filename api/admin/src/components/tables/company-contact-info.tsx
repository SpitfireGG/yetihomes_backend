...
export default function ContactInfoTable() {
    ...
    const { data, isLoading } = useGetCompanyContactInfo()
                        ...
                        {paginatedCustomers.length > 0 ? (
                            paginatedCustomers.map((highlight, indx) => (
                                <TableRow key={highlight.id}>
                                    ...
                                    <TableCell className="hidden md:table-cell">
                                        <span className="text-sm">{highlight.phone}</span>
                                    </TableCell>
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                {/* <EditHighlightsDialog
                                                    tripExtraName="highlights"
                                                    highlightId={highlight.name.id}
                                                    tripId={tripId}
                                                    highlights={
                                                        {
                                                            display_order: highlight.display_order,
                                                            description: highlight.name,
                                                            language_id: highlight.name,
                                                            title: highlight.name
                                                        }
                                                    }
                                                /> */}
                                                <DeleteDialog id={highlight.id} apiUrl={`api/company/contact-info`} />
                                            </DropdownMenuContent>
                                        </DropdownMenu>
                                    </TableCell>
                                </TableRow>
