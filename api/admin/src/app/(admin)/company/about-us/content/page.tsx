...
import { useGetCompanyAboutUsData, useLanguages } from '@/hooks/useTankstack-query'
...
const page = ({ destinationId, tripId }: Props) => {
    const destinationCrud = new CRUD(`api/company/about-us`)
    const { data } = useGetCompanyAboutUsData()
    const destination: any = data?.data
