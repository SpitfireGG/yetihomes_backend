...
const EditCsi = ({ id }: Props) => {
    ...
    const defaultTranslation = csiDetail?.translations.find(t => t.language_id === englishLanguage?.id)
    ...
    useEffect(() => {
        ...
        setFormData({
            ...
            slug: csiDetail.slug,
            translations: csiDetail.translations?.map((t) => ({
