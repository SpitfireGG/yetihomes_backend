...
import {
    useCompanyGetAchievementsById,
    useCompanyGetAffilationsById,
    useLanguages,
...
import { CompanyAffiliationTranslationDataForm } from '@/@types/company/affiliation'
...
const AddContentForm = ({ destinationId, tripId }: Props) => {
    ...
    const [formData, setFormData] = useState<CompanyAffiliationTranslationDataForm>({
        link: '',
        translations: [],
    })
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            router.push("/company/affilations")
        } catch (error: unknown) {
