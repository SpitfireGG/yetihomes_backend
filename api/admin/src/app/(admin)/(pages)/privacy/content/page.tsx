...
import { useGetCompanyPrivacy, useGetCompanyTermsData, useLanguages } from '@/hooks/useTankstack-query'
...
const page = ({ destinationId, tripId }: Props) => {
    const destinationCrud = new CRUD(`api/company/privacy-policy`)
    const { data } = useGetCompanyPrivacy()
