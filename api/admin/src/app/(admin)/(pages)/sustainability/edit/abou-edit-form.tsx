...
import { useActivities, useCurrencies, useDestinations, useGetCompanyAboutUsData, useGetCompanySustainability, useLanguages, useTripDifficulties } from '@/hooks/useTankstack-query'
...
const page = () => {
    const trips = new CRUD('api/company/sustainability-policy')
    ...
    return (
        <>
            <h1 className="text-2xl font-bold tracking-tight mt-4">Update Sustainability</h1>
                        ...
                        <div className='py-4 grid md:grid-cols-2 gap-6 w-full'>
                            ...
                            <div className='col-span-2 grid grid-cols-2  md:grid-cols-5 gap-4'>
                                <div className='space-y-3'>
                                    ...
                                    <Select value={formData.translations[0].language_id} required disabled>
