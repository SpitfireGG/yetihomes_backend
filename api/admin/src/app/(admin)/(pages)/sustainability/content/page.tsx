...
import { useGetCompanyPrivacy, useGetCompanySustainability, useGetCompanyTermsData, useLanguages } from '@/hooks/useTankstack-query'
...
const page = ({ destinationId, tripId }: Props) => {
    const destinationCrud = new CRUD(`api/company/sustainability-policy`)
    const { data } = useGetCompanySustainability()
