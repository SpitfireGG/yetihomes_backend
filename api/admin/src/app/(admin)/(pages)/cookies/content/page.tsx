...
import { useGetCompanyCookies, useGetCompanyPrivacy, useGetCompanySustainability, useGetCompanyTermsData, useLanguages } from '@/hooks/useTankstack-query'
...
const page = ({ destinationId, tripId }: Props) => {
    const destinationCrud = new CRUD(`api/company/cookie-policy`)
    const { data } = useGetCompanyCookies()
