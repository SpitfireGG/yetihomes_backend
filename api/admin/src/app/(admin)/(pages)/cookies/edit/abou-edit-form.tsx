...
import { useActivities, useCurrencies, useDestinations, useGetCompanyAboutUsData, useGetCompanyCookies, useLanguages, useTripDifficulties } from '@/hooks/useTankstack-query'
...
const page = () => {
    ...
    return (
        <>
            <h1 className="text-2xl font-bold tracking-tight mt-4">Update Cookie Policy</h1>
